$(function () {
    ...
    //编辑店铺信息的URL
    var editShopUrl = '/shop/shopadmin/mondifyshop';
    ...
    $('#submit').click(function () {
        ...
        //将shop json对象转成字符流保存至表单对象key为shopStr的键值对
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.success) {
                    ...
                    if (!isEdit) {
                        //如果为注册操作，成功后返回店铺列表
                        window.location.href = "shop/shopadmin/shoplist";
                    }
                } else {
